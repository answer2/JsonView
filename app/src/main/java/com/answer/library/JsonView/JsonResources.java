...
import com.answer.library.JsonView.interfaces.MetaTable;
...
/**
 * @Author AnswerDev
 * @Date 2023/02/19 07:20
 * @Describe 用来管理动态加载的资源 
 * Created by Administrator
 */
 
@SuppressLint("UseSparseArrays")
public class JsonResources extends Resources implements MetaTable{
    
    public static final String TAG = "JsonResources";
     ...
     */
    public JsonResources(AssetManager assets, DisplayMetrics metrics, Configuration config) {
